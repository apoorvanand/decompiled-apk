...
public final class a_$P$ {
    private static byte[] E$_j$ = new byte[256];
    static final int[] G__G_ = new int[256];
    static final int[] Q_$2$ = new int[256];
    static final int[] R$$r_ = new int[256];
    static final int[] a_$P$ = new int[256];
    private static int[] b__J_ = new int[10];
    static final byte[] d__1_ = new byte[256];
    ...
    private static int[] G__G_(byte[] bArr, int[] iArr, int i) {
        if (bArr.length == 16) {
            int i2 = 4;
    ...
    static int[] a_$P$(byte[] bArr, int i) {
        if (bArr.length == 16) {
            int i2 = (i + 1) * 4;
            int[] iArr = new int[i2];
            int i3 = 0;
            ...
            while (i3 < 4) {
                int i5 = i4 + 1;
                int i6 = i5 + 1;
                byte b = (bArr[i4] << Ascii.CAN) | ((bArr[i5] & 255) << Ascii.DLE);
                int i7 = i6 + 1;
            ...
            while (i8 < i2) {
                ...
                if (i9 == 0) {
                    byte[] bArr2 = E$_j$;
                    i11 = ((bArr2[i11 >>> 24] & 255) | (((bArr2[(i11 >>> 16) & 255] << Ascii.CAN) | ((bArr2[(i11 >>> 8) & 255] & 255) << Ascii.DLE)) | ((bArr2[i11 & 255] & 255) << 8))) ^ b__J_[i10];
                    i10++;
                    i9 = 4;
                }
