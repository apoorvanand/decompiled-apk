...
public final class CodaBarReader extends OneDReader {
    ...
    static final char[] a = ALPHABET_STRING.toCharArray();
    ...
    private int findStartPattern() {
        for (int i = 1; i < this.counterLength; i += 2) {
            ...
            if (narrowWidePattern != -1 && a(STARTEND_ENCODING, a[narrowWidePattern])) {
                int i2 = 0;
    ...
    private void validatePattern(int i) {
        ...
        int i4 = 0;
        while (true) {
            int i5 = b[this.decodeRowResult.charAt(i4)];
        ...
        loop3:
        while (true) {
            int i10 = b[this.decodeRowResult.charAt(i2)];
            int i11 = 6;
            while (i11 >= 0) {
