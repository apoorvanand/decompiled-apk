...
public final class Encoder {
    ...
    static void a(java.lang.String r6, com.google.zxing.common.BitArray r7) {
        /*
    ...
    public static QRCode encode(String str, ErrorCorrectionLevel errorCorrectionLevel, Map<EncodeHintType, ?> map) {
        ...
        a(chooseMode, bitArray);
        BitArray bitArray2 = new BitArray();
        a(str, chooseMode, bitArray2, str2);
        ...
        a(chooseMode == Mode.BYTE ? bitArray2.getSizeInBytes() : str.length(), version, chooseMode, bitArray3);
        ...
        BitArray a = a(bitArray3, version.getTotalCodewords(), totalCodewords, eCBlocksForLevel.getNumBlocks());
        ...
        int chooseMaskPattern = chooseMaskPattern(a, errorCorrectionLevel, version, byteMatrix);
        qRCode.setMaskPattern(chooseMaskPattern);
        MatrixUtil.a(a, errorCorrectionLevel, version, chooseMaskPattern, byteMatrix);
