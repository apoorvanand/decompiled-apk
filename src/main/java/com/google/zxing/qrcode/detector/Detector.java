...
public class Detector {
    ...
    /* access modifiers changed from: protected */
    public final DetectorResult a(FinderPatternInfo finderPatternInfo) {
        ResultPoint[] resultPointArr;
        FinderPattern topLeft = finderPatternInfo.getTopLeft();
        FinderPattern topRight = finderPatternInfo.getTopRight();
        FinderPattern bottomLeft = finderPatternInfo.getBottomLeft();
        float a = a(topLeft, topRight, bottomLeft);
        if (a >= 1.0f) {
            int computeDimension = computeDimension(topLeft, topRight, bottomLeft, a);
            ...
            if (provisionalVersionForDimension.getAlignmentPatternCenters().length > 0) {
                ...
                while (true) {
                    ...
                    try {
                        alignmentPattern = a(a, x2, y2, (float) i);
                        break;
    ...
    /* access modifiers changed from: protected */
    public final AlignmentPattern a(float f, int i, int i2, float f2) {
        int i3 = (int) (f2 * f);
        ...
        if (((float) min) >= f3) {
            ...
            if (((float) min2) >= f3) {
                return new AlignmentPatternFinder(this.image, max, max2, min, min2, f, this.resultPointCallback).a();
            }
            throw NotFoundException.getNotFoundInstance();
        }
        throw NotFoundException.getNotFoundInstance();
    ...
    public final DetectorResult detect(Map<DecodeHintType, ?> map) {
        ...
        return a(new FinderPatternFinder(this.image, this.resultPointCallback).a(map));
    }
}
