...
EDGE_INSN: B:94:0x00e7->B:64:0x00e7 ?: BREAK  ] */
    ...
    private float crossCheckHorizontal(int i, int i2, int i3, int i4) {
        ...
        if (i5 >= 0 && crossCheckStateCount2[1] <= i3) {
            ...
            if (i6 != width && crossCheckStateCount2[3] < i3) {
                ...
                if (crossCheckStateCount2[4] < i3 && Math.abs(((((crossCheckStateCount2[0] + crossCheckStateCount2[1]) + crossCheckStateCount2[2]) + crossCheckStateCount2[3]) + crossCheckStateCount2[4]) - i4) * 5 < i4 && a(crossCheckStateCount2)) {
    ...
    private float crossCheckVertical(int i, int i2, int i3, int i4) {
        ...
        if (i5 >= 0 && crossCheckStateCount2[1] <= i3) {
            ...
            if (i6 != height && crossCheckStateCount2[3] < i3) {
                ...
                if (crossCheckStateCount2[4] < i3 && Math.abs(((((crossCheckStateCount2[0] + crossCheckStateCount2[1]) + crossCheckStateCount2[2]) + crossCheckStateCount2[3]) + crossCheckStateCount2[4]) - i4) * 5 < i4 * 2 && a(crossCheckStateCount2)) {
                    return centerFromEnd(crossCheckStateCount2, i6);
                }
            }
        }
    ...
    public final FinderPatternInfo a(Map<DecodeHintType, ?> map) {
        ...
        if (!Float.isNaN(crossCheckVertical)) {
            ...
            if (!Float.isNaN(crossCheckHorizontal) && (!z || crossCheckDiagonal(i4, (int) crossCheckHorizontal, iArr[2], i3))) {
                ...
                while (true) {
                    ...
                    if (finderPattern.a(f, crossCheckVertical, crossCheckHorizontal)) {
                        this.possibleCenters.set(i5, finderPattern.b(crossCheckVertical, crossCheckHorizontal, f));
                        z2 = true;
                        break;
                    }
                    i5++;
