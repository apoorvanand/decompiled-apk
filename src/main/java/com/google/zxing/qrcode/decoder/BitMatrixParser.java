...
final class BitMatrixParser {
    ...
    public FormatInformation a() {
        ...
        this.parsedFormatInfo = FormatInformation.b(copyBit, i);
    ...
    public byte[] c() {
        ...
        int height = this.bitMatrix.getHeight();
        dataMask.a(this.bitMatrix, height);
        BitMatrix a2 = b.a();
    ...
    public void d() {
        if (this.parsedFormatInfo != null) {
            DataMask.values()[this.parsedFormatInfo.b()].a(this.bitMatrix, this.bitMatrix.getHeight());
        }
    }
