...
public final class Detector {
    ...
    private static float distance(Point point, Point point2) {
        return MathUtils.distance(point.b(), point.c(), point2.b(), point2.c());
    }
    ...
    private ResultPoint[] getBullsEyeCorners(Point point) {
        ...
        if (i == 5 || i == 7) {
            ...
            ResultPoint[] resultPointArr = {new ResultPoint(((float) point2.b()) + 0.5f, ((float) point2.c()) - 0.5f), new ResultPoint(((float) point3.b()) + 0.5f, ((float) point3.c()) + 0.5f), new ResultPoint(((float) point4.b()) - 0.5f, ((float) point4.c()) + 0.5f), new ResultPoint(((float) point5.b()) - 0.5f, ((float) point5.c()) - 0.5f)};
    ...
    private int getColor(Point point, Point point2) {
        ...
        float b = ((float) (point2.b() - point.b())) / distance;
        float c = ((float) (point2.c() - point.c())) / distance;
        boolean z = this.image.get(point.b(), point.c());
        int ceil = (int) Math.ceil((double) distance);
        boolean z2 = false;
        float b2 = (float) point.b();
        float c2 = (float) point.c();
        int i = 0;
        for (int i2 = 0; i2 < ceil; i2++) {
            b2 += b;
            c2 += c;
            if (this.image.get(MathUtils.round(b2), MathUtils.round(c2)) != z) {
                i++;
            }
        }
    ...
    private Point getFirstDifferent(Point point, boolean z, int i, int i2) {
        ...
        while (true) {
            c += i2;
            if (!isValid(b, c) || this.image.get(b, c) != z) {
                int i3 = b - i;
                int i4 = c - i2;
            } else {
                b += i;
    ...
    private Point getMatrixCenter() {
        ...
        try {
            ...
            int i = width + 7;
            int i2 = height - 7;
            ResultPoint a = getFirstDifferent(new Point(i, i2), false, 1, -1).a();
            int i3 = height + 7;
            ResultPoint a2 = getFirstDifferent(new Point(i, i3), false, 1, 1).a();
            int i4 = width - 7;
            ResultPoint a3 = getFirstDifferent(new Point(i4, i3), false, -1, 1).a();
            resultPoint4 = getFirstDifferent(new Point(i4, i2), false, -1, -1).a();
            ResultPoint resultPoint9 = a2;
            resultPoint = a3;
            resultPoint3 = a;
        ...
        try {
            ...
            int i5 = round + 7;
            int i6 = round2 - 7;
            resultPoint6 = getFirstDifferent(new Point(i5, i6), false, 1, -1).a();
            int i7 = round2 + 7;
            resultPoint5 = getFirstDifferent(new Point(i5, i7), false, 1, 1).a();
            int i8 = round - 7;
            resultPoint7 = getFirstDifferent(new Point(i8, i7), false, -1, 1).a();
            resultPoint8 = getFirstDifferent(new Point(i8, i6), false, -1, -1).a();
        }
