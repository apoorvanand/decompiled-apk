...
public final class Decoder {
    private static final String[] DIGIT_TABLE = {"CTRL_PS", " ", AppEventsConstants.EVENT_PARAM_VALUE_NO, AppEventsConstants.EVENT_PARAM_VALUE_YES, ExifInterface.GPS_MEASUREMENT_2D, ExifInterface.GPS_MEASUREMENT_3D, "4", "5", "6", "7", "8", "9", ",", ".", "CTRL_UL", "CTRL_US"};
    ...
    public DecoderResult decode(AztecDetectorResult aztecDetectorResult) {
        ...
        DecoderResult decoderResult = new DecoderResult(a(correctBits), getEncodedData(correctBits), (List<byte[]>) null, (String) null);
