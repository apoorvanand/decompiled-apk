...
public final class PDF417 {
    ...
    private void encodeLowLevel(CharSequence charSequence, int i, int i2, int i3, BarcodeMatrix barcodeMatrix2) {
        ...
        while (i7 < i2) {
            int i9 = i7 % 3;
            barcodeMatrix2.a();
            encodeChar(START_PATTERN, 17, barcodeMatrix2.b());
            if (i9 == 0) {
                i5 = (i7 / 3) * 30;
                i4 = ((i2 - 1) / 3) + i5;
                i6 = i - 1;
            ...
            int i12 = i5 + i6;
            encodeChar(CODEWORD_TABLE[i9][i4], 17, barcodeMatrix2.b());
            int i13 = i8;
            for (int i14 = 0; i14 < i; i14++) {
                encodeChar(CODEWORD_TABLE[i9][charSequence.charAt(i13)], 17, barcodeMatrix2.b());
                i13++;
            }
            if (this.compact) {
                encodeChar(STOP_PATTERN, 1, barcodeMatrix2.b());
            } else {
                encodeChar(CODEWORD_TABLE[i9][i12], 17, barcodeMatrix2.b());
                encodeChar(STOP_PATTERN, 18, barcodeMatrix2.b());
            }
            i7++;
            i8 = i13;
        }
    ...
    public void generateBarcodeLogic(String str, int i) {
        int a = PDF417ErrorCorrection.a(i);
        String a2 = PDF417HighLevelEncoder.a(str, this.compaction, this.encoding);
        int length = a2.length();
        int[] determineDimensions = determineDimensions(length, a);
        int i2 = determineDimensions[0];
        int i3 = determineDimensions[1];
        int numberOfPadCodewords = getNumberOfPadCodewords(length, a, i2, i3);
        if (a + length + 1 <= 929) {
            ...
            String a3 = PDF417ErrorCorrection.a(sb2, i);
            this.barcodeMatrix = new BarcodeMatrix(i3, i2);
            encodeLowLevel(sb2 + a3, i2, i3, i, this.barcodeMatrix);
            return;
        }
