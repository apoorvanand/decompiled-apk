...
final class ModulusPoly {
    ...
    public ModulusPoly a(int i, int i2) {
        if (i < 0) {
            ...
            for (int i3 = 0; i3 < length; i3++) {
                iArr[i3] = this.field.d(this.coefficients[i3], i2);
            }
    ...
    public ModulusPoly a(ModulusPoly modulusPoly) {
        if (!this.field.equals(modulusPoly.field)) {
            ...
            for (int i = length; i < iArr2.length; i++) {
                iArr4[i] = this.field.b(iArr[i - length], iArr2[i]);
            }
    ...
    public int b(int i) {
        ...
        for (int i4 = 1; i4 < length; i4++) {
            ...
            i3 = modulusGF.b(modulusGF.d(i, i3), this.coefficients[i4]);
        }
        return i3;
    }
    ...
    /* access modifiers changed from: package-private */
    public ModulusPoly c() {
        int length = this.coefficients.length;
        int[] iArr = new int[length];
        for (int i = 0; i < length; i++) {
            iArr[i] = this.field.c(0, this.coefficients[i]);
        }
        return new ModulusPoly(this.field, iArr);
    }
    ...
    public ModulusPoly c(int i) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            iArr[i2] = this.field.d(this.coefficients[i2], i);
        }
        return new ModulusPoly(this.field, iArr);
    }
