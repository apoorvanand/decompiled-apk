...
public final class zaaw extends GoogleApiClient implements zabt {
    ...
    private final void zae(int i) {
        ...
        if (this.zagt == null) {
            boolean z = false;
            boolean z2 = false;
            for (Api.Client next : this.b.values()) {
                if (next.requiresSignIn()) {
                    z = true;
                }
                if (next.providesSignIn()) {
    ...
    public final <C extends Api.Client> C getClient(@NonNull Api.AnyClientKey<C> anyClientKey) {
        C c2 = (Api.Client) this.b.get(anyClientKey);
    ...
    public final boolean hasConnectedApi(@androidx.annotation.NonNull com.google.android.gms.common.api.Api<?> r3) {
        /*
            ...
            return r1
        L_0x0008:
            java.util.Map<com.google.android.gms.common.api.Api$AnyClientKey<?>, com.google.android.gms.common.api.Api$Client> r0 = r2.b
