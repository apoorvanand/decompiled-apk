...
public class ExperimentTokens extends AbstractSafeParcelable {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ExperimentTokens) {
            ...
            return zzn.a(this.zzp, experimentTokens.zzp) && Arrays.equals(this.zzq, experimentTokens.zzq) && zzn.a(zza(this.zzr), zza(experimentTokens.zzr)) && zzn.a(zza(this.zzs), zza(experimentTokens.zzs)) && zzn.a(zza(this.zzt), zza(experimentTokens.zzt)) && zzn.a(zza(this.zzu), zza(experimentTokens.zzu)) && zzn.a(zza(this.zzv), zza(experimentTokens.zzv)) && zzn.a(zza(this.zzw), zza(experimentTokens.zzw));
        }
    }
