...
public final class zzes {
    ...
    public final void zzc(String str, long j) {
        ...
        long j3 = j2 + 1;
        boolean z = (this.zzmj.zzz().c().nextLong() & LongCompanionObject.MAX_VALUE) < LongCompanionObject.MAX_VALUE / j3;
    ...
    public final Pair<String, Long> zzhl() {
        ...
        zzhk();
        return (string == null || j3 <= 0) ? zzeo.a : new Pair<>(string, Long.valueOf(j3));
    }
}
