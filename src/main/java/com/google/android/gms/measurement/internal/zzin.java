...
public final class zzin implements ServiceConnection, BaseGmsClient.BaseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener {
    ...
    public final void onConnected(@Nullable Bundle bundle) {
        ...
        synchronized (this) {
            try {
                this.a.zzaa().zza((Runnable) new zzio(this, (zzdx) this.zzru.getService()));
    ...
    public final void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        this.a.zzaa().zza((Runnable) new zziq(this));
    }

    @MainThread
    public final void onConnectionSuspended(int i) {
        Preconditions.checkMainThread("MeasurementServiceConnection.onConnectionSuspended");
        this.a.zzab().zzgr().zzao("Service connection suspended");
        this.a.zzaa().zza((Runnable) new zzir(this));
    }

    /* JADX WARNING: Can't wrap try/catch for region: R(2:22|23) */
    /* JADX WARNING: Code restructure failed: missing block: B:23:?, code lost:
        r3.a.zzab().zzgk().zzao("Service connect failed to get IMeasurementService");
     */
    ...
    public final void onServiceConnected(android.content.ComponentName r4, android.os.IBinder r5) {
        /*
            ...
            com.google.android.gms.measurement.internal.zzhv r4 = r3.a     // Catch:{ all -> 0x001c }
        ...
        L_0x0041:
            r0 = r1
        L_0x0042:
            com.google.android.gms.measurement.internal.zzhv r5 = r3.a     // Catch:{ RemoteException -> 0x0062 }
        ...
        L_0x0052:
            ...
            goto L_0x0071
        L_0x0062:
            com.google.android.gms.measurement.internal.zzhv r5 = r3.a     // Catch:{ all -> 0x001c }
        ...
        L_0x0071:
            ...
            com.google.android.gms.measurement.internal.zzhv r5 = r3.a     // Catch:{ IllegalArgumentException -> 0x0097 }
            android.content.Context r5 = r5.getContext()     // Catch:{ IllegalArgumentException -> 0x0097 }
            com.google.android.gms.measurement.internal.zzhv r0 = r3.a     // Catch:{ IllegalArgumentException -> 0x0097 }
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        ...
        this.a.zzab().zzgr().zzao("Service disconnected");
        this.a.zzaa().zza((Runnable) new zzip(this, componentName));
    }
    ...
    public final void zzb(Intent intent) {
        ...
        synchronized (this) {
            if (this.zzrt) {
                this.a.zzab().zzgs().zzao("Connection attempt already in progress");
                return;
            }
            this.a.zzab().zzgs().zzao("Using local app measurement service");
            this.zzrt = true;
            instance.bindService(context, intent, this.a.zzre, 129);
        }
    }
    ...
    public final void zzix() {
        ...
        synchronized (this) {
            if (this.zzrt) {
                ...
                this.a.zzab().zzgs().zzao("Connecting to remote service");
                this.zzrt = true;
                this.zzru.checkAvailabilityAndConnect();
            } else {
                this.a.zzab().zzgs().zzao("Already awaiting connection attempt");
            }
        }
    }
}
