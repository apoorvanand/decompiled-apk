...
final class zzf {
    ...
    public final void zza(Boolean bool) {
        this.zzj.zzaa().zzo();
        this.zzde = !zzjs.a(this.zzcv, bool);
        this.zzcv = bool;
    }
    ...
    public final void zza(String str) {
        this.zzj.zzaa().zzo();
        this.zzde |= !zzjs.d(this.zzcf, str);
        this.zzcf = str;
    }
    ...
    public final void zzau() {
        ...
        long j = this.zzcj + 1;
        if (j > 2147483647L) {
            this.zzj.zzab().zzgn().zza("Bundle index overflow. appId", zzef.a(this.zzce));
            j = 0;
        }
        this.zzde = true;
        this.zzcj = j;
    ...
    public final void zzb(String str) {
        ...
        this.zzde |= !zzjs.d(this.zzcg, str);
        this.zzcg = str;
    }
    ...
    public final void zzc(String str) {
        ...
        this.zzde |= !zzjs.d(this.zzcu, str);
        this.zzcu = str;
    }
    ...
    public final void zzd(String str) {
        this.zzj.zzaa().zzo();
        this.zzde |= !zzjs.d(this.zzch, str);
        this.zzch = str;
    }
    ...
    public final void zze(String str) {
        this.zzj.zzaa().zzo();
        this.zzde |= !zzjs.d(this.zzci, str);
        this.zzci = str;
    }
    ...
    public final void zzf(String str) {
        this.zzj.zzaa().zzo();
        this.zzde |= !zzjs.d(this.zzcm, str);
        this.zzcm = str;
    }
    ...
    public final void zzg(String str) {
        this.zzj.zzaa().zzo();
        this.zzde |= !zzjs.d(this.zzco, str);
        this.zzco = str;
    }
    ...
    public final void zzh(String str) {
        this.zzj.zzaa().zzo();
        this.zzde |= !zzjs.d(this.zzdd, str);
        this.zzdd = str;
    }
