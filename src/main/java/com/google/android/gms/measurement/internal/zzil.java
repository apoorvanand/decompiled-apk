    ...
    public final void run() {
        ...
        synchronized (this.zzrl) {
            try {
                ...
                if (d == null) {
                    this.zzrd.zzab().zzgk().zza("Failed to get user properties", zzef.a(this.zzdn), this.zzx, this.zzas);
                ...
                if (TextUtils.isEmpty(this.zzdn)) {
                    ...
                    zza = d.zza(this.zzx, this.zzas, this.zzbi, this.zzpg);
                } else {
                    atomicReference2 = this.zzrl;
                    zza = d.zza(this.zzdn, this.zzx, this.zzas, this.zzbi);
                }
                ...
                try {
                    this.zzrd.zzab().zzgk().zza("Failed to get user properties", zzef.a(this.zzdn), this.zzx, e);
                    this.zzrl.set(Collections.emptyList());
                    atomicReference = this.zzrl;
                } catch (Throwable th) {
                    this.zzrl.notify();
