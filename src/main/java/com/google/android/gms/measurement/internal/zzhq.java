...
public final class zzhq extends zzg {
    ...
    public final void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        if (bundle != null && (bundle2 = bundle.getBundle("com.google.app_measurement.screen_service")) != null) {
            this.zzqr.put(activity, new zzhr(bundle2.getString("name"), bundle2.getString("referrer_name"), bundle2.getLong(ShareConstants.WEB_DIALOG_PARAM_ID)));
        }
    }
    ...
    public final void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
        ...
        if (bundle != null && (zzhr = this.zzqr.get(activity)) != null) {
            ...
            bundle2.putLong(ShareConstants.WEB_DIALOG_PARAM_ID, zzhr.zzqw);
    ...
    public final void setCurrentScreen(@NonNull Activity activity, @Size(max = 36, min = 1) @Nullable String str, @Size(max = 36, min = 1) @Nullable String str2) {
        if (this.zzqp == null) {
            ...
            boolean d = zzjs.d(this.zzqp.zzqu, str);
            if (equals && d) {
