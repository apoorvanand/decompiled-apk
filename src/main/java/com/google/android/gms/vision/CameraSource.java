...
public class CameraSource {
    ...
    class zza implements Camera.PreviewCallback {
        ...
        public final void onPreviewFrame(byte[] bArr, Camera camera) {
            CameraSource.this.zzp.a(bArr, camera);
        }
    }
    ...
    class zzb implements Runnable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:29:0x0080, code lost:
            com.google.android.gms.vision.CameraSource.b(r6.zzt).addCallbackBuffer(r2.array());
         */
        ...
        public final void run() {
            ...
            L_0x0000:
                ...
                monitor-enter(r0)
            L_0x0003:
                boolean r1 = r6.zzv     // Catch:{ all -> 0x008e }
                if (r1 == 0) goto L_0x001b
                java.nio.ByteBuffer r1 = r6.zzy     // Catch:{ all -> 0x008e }
                if (r1 != 0) goto L_0x001b
            ...
            L_0x001b:
                ...
                return
            L_0x0021:
                com.google.android.gms.vision.Frame$Builder r1 = new com.google.android.gms.vision.Frame$Builder     // Catch:{ all -> 0x008e }
                r1.<init>()     // Catch:{ all -> 0x008e }
                java.nio.ByteBuffer r2 = r6.zzy     // Catch:{ all -> 0x008e }
                com.google.android.gms.vision.CameraSource r3 = com.google.android.gms.vision.CameraSource.this     // Catch:{ all -> 0x008e }
                com.google.android.gms.common.images.Size r3 = r3.zzh     // Catch:{ all -> 0x008e }
                int r3 = r3.getWidth()     // Catch:{ all -> 0x008e }
                com.google.android.gms.vision.CameraSource r4 = com.google.android.gms.vision.CameraSource.this     // Catch:{ all -> 0x008e }
                com.google.android.gms.common.images.Size r4 = r4.zzh     // Catch:{ all -> 0x008e }
                int r4 = r4.getHeight()     // Catch:{ all -> 0x008e }
                r5 = 17
                com.google.android.gms.vision.Frame$Builder r1 = r1.setImageData(r2, r3, r4, r5)     // Catch:{ all -> 0x008e }
                int r2 = r6.zzx     // Catch:{ all -> 0x008e }
                com.google.android.gms.vision.Frame$Builder r1 = r1.setId(r2)     // Catch:{ all -> 0x008e }
                long r2 = r6.zzw     // Catch:{ all -> 0x008e }
                com.google.android.gms.vision.Frame$Builder r1 = r1.setTimestampMillis(r2)     // Catch:{ all -> 0x008e }
                com.google.android.gms.vision.CameraSource r2 = com.google.android.gms.vision.CameraSource.this     // Catch:{ all -> 0x008e }
                int r2 = r2.rotation     // Catch:{ all -> 0x008e }
                com.google.android.gms.vision.Frame$Builder r1 = r1.setRotation(r2)     // Catch:{ all -> 0x008e }
                com.google.android.gms.vision.Frame r1 = r1.build()     // Catch:{ all -> 0x008e }
                java.nio.ByteBuffer r2 = r6.zzy     // Catch:{ all -> 0x008e }
                r3 = 0
                r6.zzy = r3     // Catch:{ all -> 0x008e }
                monitor-exit(r0)     // Catch:{ all -> 0x008e }
