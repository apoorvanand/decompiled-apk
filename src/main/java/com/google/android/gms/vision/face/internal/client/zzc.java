...
public final class zzc extends zzm<zzg> {
    ...
    public final /* synthetic */ Object a(DynamiteModule dynamiteModule, Context context) {
        zzj asInterface = zzk.asInterface(dynamiteModule.instantiate(zzp.zza(context, "com.google.android.gms.vision.dynamite.face") ? "com.google.android.gms.vision.face.NativeFaceDetectorV2Creator" : "com.google.android.gms.vision.face.ChimeraNativeFaceDetectorCreator"));
        if (asInterface == null) {
            return null;
        }
    ...
    public final Face[] zzb(ByteBuffer byteBuffer, zzn zzn) {
        ...
        try {
            FaceParcel[] zzc = ((zzg) b()).zzc(ObjectWrapper.wrap(byteBuffer), zzn);
