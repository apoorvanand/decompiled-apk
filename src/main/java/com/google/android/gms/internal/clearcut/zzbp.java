...
final class zzbp implements zzfr {
    ...
    private zzbp(zzbn zzbn) {
        this.zzfo = (zzbn) zzci.a(zzbn, "output");
        this.zzfo.a = this;
    }

    public static zzbp zza(zzbn zzbn) {
        return zzbn.a != null ? zzbn.a : new zzbp(zzbn);
    }
    ...
    public final <K, V> void zza(int i, zzdh<K, V> zzdh, Map<K, V> map) {
        for (Map.Entry next : map.entrySet()) {
            this.zzfo.zzb(i, 2);
            this.zzfo.zzo(zzdg.a(zzdh, next.getKey(), next.getValue()));
            zzdg.a(this.zzfo, zzdh, next.getKey(), next.getValue());
        }
    }
