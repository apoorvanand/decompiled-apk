...
public final class zzca implements zzce {
    ...
    static final Map<Uri, zzca> a = new ArrayMap();
    ...
    private zzca(ContentResolver contentResolver, Uri uri2) {
        ...
        this.uri = uri2;
        this.zzaai.registerContentObserver(uri2, false, new zzcc(this, (Handler) null));
    }
    ...
    public static com.google.android.gms.internal.measurement.zzca zza(android.content.ContentResolver r3, android.net.Uri r4) {
        /*
            ...
            monitor-enter(r0)
            java.util.Map<android.net.Uri, com.google.android.gms.internal.measurement.zzca> r1 = a     // Catch:{ all -> 0x001a }
            ...
            java.util.Map<android.net.Uri, com.google.android.gms.internal.measurement.zzca> r3 = a     // Catch:{ SecurityException -> 0x0017 }
