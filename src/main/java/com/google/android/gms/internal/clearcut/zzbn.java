...
public abstract class zzbn extends zzba {
    ...
    public static final boolean zzfy = zzfd.a();
    zzbp a;
    ...
    static class zza extends zzbn {
        ...
        public final void a(int i, zzdo zzdo, zzef zzef) {
            zzb(i, 2);
            zzas zzas = (zzas) zzdo;
            int b = zzas.b();
            if (b == -1) {
            ...
            zzo(b);
            zzef.zza(zzdo, this.a);
        }

        /* access modifiers changed from: package-private */
        public final void a(zzdo zzdo, zzef zzef) {
            zzas zzas = (zzas) zzdo;
            int b = zzas.b();
            if (b == -1) {
                b = zzef.zzm(zzas);
        ...
        public final void zzb(long j) {
            if (!zzbn.zzfy || zzag() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    this.position = i3 + 1;
                    zzfd.a(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
                this.position = i4 + 1;
                zzfd.a(bArr4, (long) i4, (byte) ((int) j));
            }
        }
        ...
        public final void zzg(String str) {
            ...
            try {
                ...
                if (zzt2 == zzt) {
                    ...
                    int a = zzff.a(str, this.buffer, this.position, zzag());
                    this.position = i;
                    zzo((a - i) - zzt2);
                    this.position = a;
                    return;
                }
                zzo(zzff.a((CharSequence) str));
                this.position = zzff.a(str, this.buffer, this.position, zzag());
            } catch (zzfi e) {
                this.position = i;
                a(str, e);
        ...
        public final void zzo(int i) {
            if (!zzbn.zzfy || zzag() < 10) {
                ...
                while ((i & -128) != 0) {
                    ...
                    int i4 = this.position;
                    this.position = i4 + 1;
                    zzfd.a(bArr3, (long) i4, (byte) ((i & 127) | 128));
                    i >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i5 = this.position;
                this.position = i5 + 1;
                zzfd.a(bArr4, (long) i5, (byte) i);
            }
        }
    ...
    static final class zzd extends zzbn {
        ...
        private final void zzi(String str) {
            try {
                zzff.a((CharSequence) str, this.zzgd);
            } catch (IndexOutOfBoundsException e) {
            ...
            if (this.zzgi <= this.zzgh) {
                ...
                while (true) {
                    ...
                    if (j2 >= this.zzgg) {
                        ...
                        this.zzgi = j2 + 1;
                        zzfd.a(j2, (byte) ((((int) j) & 127) | 128));
                        j >>>= 7;
                    }
                }
            }
            this.zzgi = 1 + j2;
            zzfd.a(j2, (byte) ((int) j));
        }
    ...
    static int b(int i, zzdo zzdo, zzef zzef) {
        return zzr(i) + b(zzdo, zzef);
    }

    static int b(zzdo zzdo, zzef zzef) {
        zzas zzas = (zzas) zzdo;
        int b = zzas.b();
        if (b == -1) {
            b = zzef.zzm(zzas);
    ...
    @Deprecated
    static int c(int i, zzdo zzdo, zzef zzef) {
        int zzr = zzr(i) << 1;
        zzas zzas = (zzas) zzdo;
        int b = zzas.b();
        if (b == -1) {
    ...
    public static zzbn zza(ByteBuffer byteBuffer) {
        ...
        if (byteBuffer.isDirect() && !byteBuffer.isReadOnly()) {
            return zzfd.b() ? new zze(byteBuffer) : new zzd(byteBuffer);
        }
    ...
    public static int zzh(String str) {
        int i;
        try {
            i = zzff.a((CharSequence) str);
        } catch (zzfi unused) {
            i = str.getBytes(zzci.a).length;
        }
        return zzt(i) + i;
    }
    ...
    /* access modifiers changed from: package-private */
    public abstract void a(int i, zzdo zzdo, zzef zzef);

    /* access modifiers changed from: package-private */
    public abstract void a(zzdo zzdo, zzef zzef);

    /* access modifiers changed from: package-private */
    public final void a(String str, zzfi zzfi) {
