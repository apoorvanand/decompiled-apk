...
final class zzhy {
    private static final zzhz zzamz = ((!(zzhv.a() && zzhv.b()) || zzdi.a()) ? new zzic() : new zzie());
    ...
    static int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return zzamz.a(charSequence, bArr, i, i2);
    }

    static String a(byte[] bArr, int i, int i2) {
        return zzamz.b(bArr, i, i2);
    }
    ...
    static void a(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        if (byteBuffer.hasArray()) {
            ...
            zzhz.a(charSequence, byteBuffer);
        } else {
            zzhz.b(charSequence, byteBuffer);
        }
    }
    ...
    public static boolean zzh(byte[] bArr) {
        return zzamz.a(bArr, 0, bArr.length);
    }
