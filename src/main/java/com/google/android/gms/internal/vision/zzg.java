...
public final class zzg extends zzm<zzh> {
    ...
    public final /* synthetic */ java.lang.Object a(com.google.android.gms.dynamite.DynamiteModule r4, android.content.Context r5) {
        /*
            r3 = this;
        ...
        L_0x0022:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.vision.zzg.a(com.google.android.gms.dynamite.DynamiteModule, android.content.Context):java.lang.Object");
    }
    ...
    public final Barcode[] zza(Bitmap bitmap, zzn zzn) {
        ...
        try {
            return ((zzh) b()).zzb(ObjectWrapper.wrap(bitmap), zzn);
    ...
    public final Barcode[] zza(ByteBuffer byteBuffer, zzn zzn) {
        ...
        try {
            return ((zzh) b()).zza(ObjectWrapper.wrap(byteBuffer), zzn);
        } catch (RemoteException e) {
            Log.e("BarcodeNativeHandle", "Error calling native barcode detector", e);
            return new Barcode[0];
        }
