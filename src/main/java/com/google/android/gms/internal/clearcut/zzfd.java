...
final class zzfd {
    ...
    private static final Class<?> zzfb = zzaw.b();
    private static final boolean zzfy = zzeg();
    private static final Unsafe zzmh = c();
    ...
    static final class zzc extends zzd {
        ...
        public final void zza(byte[] bArr, long j, long j2, long j3) {
            this.a.copyMemory(bArr, zzfd.zzpk + j, (Object) null, j2, j3);
        }
    ...
    static {
        /*
            ...
            zzmh = r0
            java.lang.Class r0 = com.google.android.gms.internal.clearcut.zzaw.b()
            zzfb = r0
        ...
        L_0x002d:
            ...
            goto L_0x0054
        L_0x002f:
            boolean r0 = com.google.android.gms.internal.clearcut.zzaw.a()
    ...
    private static Field zzei() {
        Field zzb2;
        if (zzaw.a() && (zzb2 = zzb(Buffer.class, "effectiveDirectAddress")) != null) {
            return zzb2;
        }
    ...
    private static int zzg(Class<?> cls) {
        if (zzfy) {
            return zzpi.a.arrayBaseOffset(cls);
        }
        return -1;
    }
    ...
    private static int zzh(Class<?> cls) {
        if (zzfy) {
            return zzpi.a.arrayIndexScale(cls);
        }
        return -1;
    }
