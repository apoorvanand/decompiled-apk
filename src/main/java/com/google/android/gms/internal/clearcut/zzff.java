...
final class zzff {
    private static final zzfg zzqb = (zzfd.a() && zzfd.b() ? new zzfj() : new zzfh());
    ...
    static int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return zzqb.a(charSequence, bArr, i, i2);
    }
    ...
    static void a(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        if (byteBuffer.hasArray()) {
            ...
            zzfg.a(charSequence, byteBuffer);
        } else {
            zzfg.b(charSequence, byteBuffer);
        }
    }
    ...
    public static boolean zze(byte[] bArr) {
        return zzqb.a(bArr, 0, bArr.length);
    }

    public static boolean zze(byte[] bArr, int i, int i2) {
        return zzqb.a(bArr, i, i2);
    }
