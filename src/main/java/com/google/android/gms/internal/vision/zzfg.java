...
final class zzfg implements zzjj {
    ...
    private zzfg(zzfe zzfe) {
        this.zzsd = (zzfe) zzga.a(zzfe, "output");
        this.zzsd.a = this;
    }

    public static zzfg zza(zzfe zzfe) {
        return zzfe.a != null ? zzfe.a : new zzfg(zzfe);
    }
    ...
    public final <K, V> void zza(int i, zzgy<K, V> zzgy, Map<K, V> map) {
        for (Map.Entry next : map.entrySet()) {
            this.zzsd.zzd(i, 2);
            this.zzsd.zzas(zzgx.a(zzgy, next.getKey(), next.getValue()));
            zzgx.a(this.zzsd, zzgy, next.getKey(), next.getValue());
        }
    }
