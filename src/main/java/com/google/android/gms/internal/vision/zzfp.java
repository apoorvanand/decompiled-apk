...
final class zzfp<FieldDescriptorType extends zzfr<FieldDescriptorType>> {
    ...
    private final zzhz<FieldDescriptorType, Object> zztm = zzhz.a(16);
    ...
    static int a(zzjd zzjd, int i, Object obj) {
    ...
    static void a(zzfe zzfe, zzjd zzjd, int i, Object obj) {
        if (zzjd == zzjd.GROUP) {
            zzhf zzhf = (zzhf) obj;
            zzga.a(zzhf);
            zzfe.zzd(i, 3);
    ...
    private static void zza(com.google.android.gms.internal.vision.zzjd r2, java.lang.Object r3) {
        /*
            com.google.android.gms.internal.vision.zzga.a(r3)
            int[] r0 = com.google.android.gms.internal.vision.zzfq.a
    ...
    private static int zzb(zzjd zzjd, Object obj) {
        switch (zzfq.b[zzjd.ordinal()]) {
            ...
            case 10:
                return obj instanceof zzgi ? zzfe.zza((zzgm) (zzgi) obj) : zzfe.zzc((zzhf) obj);
            case 11:
                return obj instanceof zzeo ? zzfe.zzb((zzeo) obj) : zzfe.zzn((String) obj);
            case 12:
                return obj instanceof zzeo ? zzfe.zzb((zzeo) obj) : zzfe.zzh((byte[]) obj);
            case 13:
            ...
            case 18:
                return obj instanceof zzgb ? zzfe.zzbb(((zzgb) obj).zzr()) : zzfe.zzbb(((Integer) obj).intValue());
            default:
    ...
    private final void zzc(Map.Entry<FieldDescriptorType, Object> entry) {
        ...
        if (zzfr.zzeu()) {
            ...
            if (zza2 == null) {
                ...
                this.zztm.put(zzfr, zza2 instanceof zzhm ? zzfr.zza((zzhm) zza2, (zzhm) value) : zzfr.zza(((zzhf) zza2).zzez(), (zzhf) value).zzfg());
            }
        } else {
            this.zztm.put(zzfr, zzf(value));
        }
    ...
    private static int zzd(Map.Entry<FieldDescriptorType, Object> entry) {
        zzfr zzfr = (zzfr) entry.getKey();
        Object value = entry.getValue();
        return (zzfr.zzet() != zzji.MESSAGE || zzfr.zzeu() || zzfr.zzev()) ? zzc(zzfr, value) : value instanceof zzgi ? zzfe.zzb(((zzfr) entry.getKey()).zzr(), (zzgm) (zzgi) value) : zzfe.zzd(((zzfr) entry.getKey()).zzr(), (zzhf) value);
    }
    ...
    public final Iterator<Map.Entry<FieldDescriptorType, Object>> b() {
        return this.zzto ? new zzgl(this.zztm.a().iterator()) : this.zztm.a().iterator();
    }
    ...
    public final Iterator<Map.Entry<FieldDescriptorType, Object>> iterator() {
        return this.zzto ? new zzgl(this.zztm.entrySet().iterator()) : this.zztm.entrySet().iterator();
    }
