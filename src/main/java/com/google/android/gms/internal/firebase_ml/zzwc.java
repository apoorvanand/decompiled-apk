...
final class zzwc {
    private static final zzwe zzbri = ((!(zzwa.a() && zzwa.b()) || zzrp.a()) ? new zzwf() : new zzwh());
    ...
    static int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return zzbri.a(charSequence, bArr, i, i2);
    }

    static String a(byte[] bArr, int i, int i2) {
        return zzbri.b(bArr, i, i2);
    }
    ...
    public static boolean zzj(byte[] bArr) {
        return zzbri.a(bArr, 0, bArr.length);
    }
