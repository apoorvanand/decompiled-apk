...
public final class zae extends Drawable implements Drawable.Callback {
    ...
    public zae(Drawable drawable, Drawable drawable2) {
        ...
        zai zai = this.zann;
        zai.b = drawable.getChangingConfigurations() | zai.b;
        drawable2 = drawable2 == null ? zag.zanu : drawable2;
        this.zanp = drawable2;
        drawable2.setCallback(this);
        zai zai2 = this.zann;
        zai2.b = drawable2.getChangingConfigurations() | zai2.b;
    }
    ...
    public final int getChangingConfigurations() {
        return super.getChangingConfigurations() | this.zann.a | this.zann.b;
    }
