...
final class zzkt {
    private static final zzku zzafm = ((!(zzkq.a() && zzkq.b()) || zzge.a()) ? new zzkx() : new zzkz());
    ...
    static int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return zzafm.a(charSequence, bArr, i, i2);
    }

    static String a(byte[] bArr, int i, int i2) {
        return zzafm.b(bArr, i, i2);
    }
    ...
    public static boolean zze(byte[] bArr) {
        return zzafm.a(bArr, 0, bArr.length);
    }

    public static boolean zze(byte[] bArr, int i, int i2) {
        return zzafm.a(bArr, i, i2);
    }
