...
public final class zzha extends zzfu<zzha> implements Cloneable {
    ...
    public final int a() {
        ...
        if (!Arrays.equals(this.zzbjn, zzgb.zzse)) {
            a += zzfs.zzb(4, this.zzbjn);
        }
        if (!Arrays.equals(this.zzbjp, zzgb.zzse)) {
            a += zzfs.zzb(6, this.zzbjp);
        }
        zzgy zzgy = this.zzbjs;
        if (zzgy != null) {
            a += zzfs.zzb(7, (zzfz) zzgy);
        }
        String str2 = this.zzbjq;
        if (str2 != null && !str2.equals("")) {
            a += zzfs.zzb(8, this.zzbjq);
        }
        zzge.zzd zzd = this.zzbjo;
        if (zzd != null) {
            a += zzbn.zzc(9, (zzdo) zzd);
        }
        int i4 = this.zzbji;
        if (i4 != 0) {
            a += zzfs.zzr(11) + zzfs.zzs(i4);
        }
        String str3 = this.zzbjr;
        if (str3 != null && !str3.equals("")) {
            a += zzfs.zzb(13, this.zzbjr);
        }
        String str4 = this.zzbjt;
        if (str4 != null && !str4.equals("")) {
            a += zzfs.zzb(14, this.zzbjt);
        }
        long j2 = this.zzbju;
        if (j2 != 180000) {
            a += zzfs.zzr(15) + zzfs.zzo(zzfs.zzj(j2));
        }
        zzgz zzgz = this.zzbjv;
        if (zzgz != null) {
            a += zzfs.zzb(16, (zzfz) zzgz);
        }
        long j3 = this.zzbjg;
        if (j3 != 0) {
            a += zzfs.zzd(17, j3);
        ...
        if (iArr2 != null && iArr2.length > 0) {
            ...
            a = a + i5 + (iArr.length * 2);
        }
        zzge.zzs zzs = this.zzbkb;
        if (zzs != null) {
            a += zzbn.zzc(23, (zzdo) zzs);
        }
        String str5 = this.zzbjx;
        if (str5 != null && !str5.equals("")) {
            a += zzfs.zzb(24, this.zzbjx);
        }
        if (this.zzbkc) {
            a += zzfs.zzr(25) + 1;
        }
        String str6 = this.zzbjj;
        return (str6 == null || str6.equals("")) ? a : a + zzfs.zzb(26, this.zzbjj);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return (this.a == null || this.a.isEmpty()) ? zzha.a == null || zzha.a.isEmpty() : this.a.equals(zzha.a);
    }
