...
final class zziw {
    private static final zziy zzabt = ((!(zziu.a() && zziu.b()) || zzeg.a()) ? new zziz() : new zzjb());
    ...
    static int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return zzabt.a(charSequence, bArr, i, i2);
    }

    static String a(byte[] bArr, int i, int i2) {
        return zzabt.b(bArr, i, i2);
    }
    ...
    static void a(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        if (byteBuffer.hasArray()) {
            ...
            zziy.a(charSequence, byteBuffer);
        } else {
            zziy.b(charSequence, byteBuffer);
        }
    }
    ...
    public static boolean zzi(byte[] bArr) {
        return zzabt.a(bArr, 0, bArr.length);
    }
