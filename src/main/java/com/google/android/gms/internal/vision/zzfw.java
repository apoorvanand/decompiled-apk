...
abstract class zzfw<T extends zzfk> {
    ...
    static <T extends zzfk> T a(Class<T> cls) {
        String str;
        ...
        try {
            return (zzfk) cls.cast(((zzfw) Class.forName(str, true, classLoader).getConstructor(new Class[0]).newInstance(new Object[0])).a());
            ...
            while (it.hasNext()) {
                try {
                    arrayList.add((zzfk) cls.cast(((zzfw) it.next()).a()));
