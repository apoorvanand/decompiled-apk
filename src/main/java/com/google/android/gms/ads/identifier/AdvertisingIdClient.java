...
public class AdvertisingIdClient {
    ...
    public static Info getAdvertisingIdInfo(Context context) {
        ...
        float a = zzb.a("gads:ad_id_app_context:ping_ratio", 0.0f);
        String a2 = zzb.a("gads:ad_id_use_shared_preference:experiment_id", "");
        ...
        try {
            ...
            advertisingIdClient.zza(info, z, a, SystemClock.elapsedRealtime() - elapsedRealtime, a2, (Throwable) null);
            advertisingIdClient.finish();
            return info;
        } catch (Throwable th) {
            advertisingIdClient.finish();
    ...
    private final void zza() {
        /*
            ...
            com.google.android.gms.ads.identifier.AdvertisingIdClient$zza r1 = r6.zzi     // Catch:{ all -> 0x0026 }
            java.util.concurrent.CountDownLatch r1 = r1.a     // Catch:{ all -> 0x0026 }
