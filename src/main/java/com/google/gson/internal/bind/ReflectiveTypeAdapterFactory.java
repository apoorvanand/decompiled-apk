...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    static boolean a(Field field, boolean z, Excluder excluder2) {
    ...
    private BoundField createBoundField(Gson gson, Field field, String str, TypeToken<?> typeToken, boolean z, boolean z2) {
        ...
        TypeAdapter<?> a = jsonAdapter != null ? this.jsonAdapterFactory.a(this.constructorConstructor, gson, typeToken2, jsonAdapter) : null;
        final boolean z3 = a != null;
        if (a == null) {
            a = gson.getAdapter(typeToken2);
        }
        ...
        return new BoundField(str, z, z2) {
            ...
            public void a(JsonWriter jsonWriter, Object obj) {
                (z3 ? typeAdapter : new TypeAdapterRuntimeTypeWrapper(gson3, typeAdapter, typeToken3.getType())).write(jsonWriter, field3.get(obj));
            }

            public boolean writeField(Object obj) {
                return this.i && field3.get(obj) != obj;
            }
        };
    }
        ...
        while (cls2 != Object.class) {
            ...
            while (i < length) {
                ...
                if (excludeField || excludeField2) {
                    ...
                    if (boundField3 != null) {
                        throw new IllegalArgumentException(type + " declares multiple JSON fields named " + boundField3.h);
                    }
                }
                i++;
                z = false;
