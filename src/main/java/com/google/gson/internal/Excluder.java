...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        Excluder a = clone();
        if (z) {
            a.serializationStrategies = new ArrayList(this.serializationStrategies);
            a.serializationStrategies.add(exclusionStrategy);
        }
        if (z2) {
            a.deserializationStrategies = new ArrayList(this.deserializationStrategies);
            a.deserializationStrategies.add(exclusionStrategy);
        }
        return a;
    }
