...
public class CycleDetectingLockFactory {
    ...
    static <E extends Enum<E>> Map<E, LockGraphNode> a(Class<E> cls) {
        ...
        for (int i2 = 1; i2 < length; i2++) {
            ((LockGraphNode) newArrayListWithCapacity.get(i2)).a((Policy) Policies.THROW, (List<LockGraphNode>) newArrayListWithCapacity.subList(0, i2));
        }
        while (i < length - 1) {
            i++;
            ((LockGraphNode) newArrayListWithCapacity.get(i)).a((Policy) Policies.DISABLED, (List<LockGraphNode>) newArrayListWithCapacity.subList(i, length));
        }
    ...
    public void aboutToAcquire(CycleDetectingLock cycleDetectingLock) {
        if (!cycleDetectingLock.isAcquiredByCurrentThread()) {
            ...
            lockGraphNode.a(this.a, (List<LockGraphNode>) arrayList);
