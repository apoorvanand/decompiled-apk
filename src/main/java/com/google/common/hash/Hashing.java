...
public final class Hashing {
    ...
    private static class Adler32Holder {
        static final HashFunction a = Hashing.checksumHashFunction(ChecksumType.ADLER_32, "Hashing.adler32()");
    ...
    private static final class ConcatenatedHashFunction extends AbstractCompositeHashFunction {
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.a) * 31) + this.bits;
        }
    }

    private static class Crc32Holder {
        static final HashFunction a = Hashing.checksumHashFunction(ChecksumType.CRC_32, "Hashing.crc32()");
    ...
    private static class Murmur3_128Holder {
        ...
        static final HashFunction b = Hashing.murmur3_128(Hashing.GOOD_FAST_HASH_SEED);
    ...
    private static class Murmur3_32Holder {
        ...
        static final HashFunction b = Hashing.murmur3_32(Hashing.GOOD_FAST_HASH_SEED);
