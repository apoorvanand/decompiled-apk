...
public final class Stats implements Serializable {
    ...
    public static double meanOf(Iterator<? extends Number> it) {
        ...
        while (it.hasNext()) {
            ...
            j++;
            doubleValue = (!Doubles.isFinite(doubleValue2) || !Doubles.isFinite(doubleValue)) ? StatsAccumulator.a(doubleValue, doubleValue2) : doubleValue + ((doubleValue2 - doubleValue) / ((double) j));
        }
        return doubleValue;
    }
    ...
    public static double meanOf(double... dArr) {
        ...
        for (int i = 1; i < dArr.length; i++) {
            double d2 = dArr[i];
            d = (!Doubles.isFinite(d2) || !Doubles.isFinite(d)) ? StatsAccumulator.a(d, d2) : d + ((d2 - d) / ((double) (i + 1)));
        }
        return d;
    }
    ...
    public double populationVariance() {
        ...
        return DoubleUtils.e(this.sumOfSquaresOfDeltas) / ((double) count());
    }
    ...
    public String toString() {
        return (count() > 0 ? MoreObjects.toStringHelper((Object) this).add("count", this.count).add("mean", this.mean).add("populationStandardDeviation", populationStandardDeviation()).add("min", this.min).add("max", this.max) : MoreObjects.toStringHelper((Object) this).add("count", this.count)).toString();
    }
}
