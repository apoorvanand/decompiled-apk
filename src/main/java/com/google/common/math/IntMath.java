...
public final class IntMath {
                ...
                while (true) {
                    switch (i2) {
                        ...
                        default:
                            ...
                            i2 >>= 1;
                            if (i2 > 0) {
                                MathPreconditions.c((-46340 <= i3) & (i3 <= 46340));
                                i3 *= i3;
                            }
                    }
                }
    ...
    public static int log10(int r3, java.math.RoundingMode r4) {
        /*
            ...
            com.google.common.math.MathPreconditions.a((java.lang.String) r0, (int) r3)
            int r0 = log10Floor(r3)
            int[] r1 = b
            r1 = r1[r0]
            int[] r2 = com.google.common.math.IntMath.AnonymousClass1.a
            int r4 = r4.ordinal()
            r4 = r2[r4]
            switch(r4) {
        ...
        L_0x0031:
            r3 = 0
        L_0x0032:
            com.google.common.math.MathPreconditions.a(r3)
        L_0x0035:
            return r0
        */
    ...
    public static int sqrt(int r2, java.math.RoundingMode r3) {
        /*
            java.lang.String r0 = "x"
            com.google.common.math.MathPreconditions.b((java.lang.String) r0, (int) r2)
            int r0 = sqrtFloor(r2)
            int[] r1 = com.google.common.math.IntMath.AnonymousClass1.a
            int r3 = r3.ordinal()
            r3 = r1[r3]
            switch(r3) {
