...
public class MessengerShareContentUtility {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] b = new int[ShareMessengerGenericTemplateContent.ImageAspectRatio.values().length];
    ...
    private static String getImageRatioString(ShareMessengerGenericTemplateContent.ImageAspectRatio imageAspectRatio) {
        return (imageAspectRatio != null && AnonymousClass1.b[imageAspectRatio.ordinal()] == 1) ? IMAGE_RATIO_SQUARE : IMAGE_RATIO_HORIZONTAL;
    }

    private static String getMediaType(ShareMessengerMediaTemplateContent.MediaType mediaType) {
        return (mediaType != null && AnonymousClass1.c[mediaType.ordinal()] == 1) ? "video" : MEDIA_IMAGE;
    }
