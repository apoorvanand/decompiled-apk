...
class InAppPurchaseEventManager {
    ...
    public static void clearSkuDetailsCache() {
        ...
        if (j == 0) {
            clear = skuDetailSharedPrefs.edit();
        } else if (currentTimeMillis - j > 604800) {
            clear = skuDetailSharedPrefs.edit().clear();
        } else {
            return;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:3:0x0008, code lost:
        r1 = getClass(r3, IN_APP_BILLING_SERVICE);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.ArrayList<java.lang.String> getPurchaseHistoryInapp(android.content.Context r3, java.lang.Object r4) {
        /*
        ...
        L_0x0008:
            ...
            java.lang.Class r1 = getClass(r3, r1)
            if (r1 != 0) goto L_0x0011
            return r0
        L_0x0011:
            java.lang.String r2 = "getPurchaseHistory"
            java.lang.reflect.Method r1 = getMethod(r1, r2)
            if (r1 != 0) goto L_0x001a
            return r0
        L_0x001a:
            java.lang.String r0 = "inapp"
            java.util.ArrayList r3 = getPurchaseHistory(r3, r4, r0)
            java.util.ArrayList r3 = filterPurchasesInapp(r3)
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.appevents.internal.InAppPurchaseEventManager.getPurchaseHistoryInapp(android.content.Context, java.lang.Object):java.util.ArrayList");
    }
    ...
    private static SubscriptionType getSubsType(String str) {
        ...
        try {
            ...
            if (subscriptionType == null && !string2.isEmpty()) {
                subscriptionType = currentTimeMillis - jSONObject2.getLong(LAST_LOGGED_TIME_SEC) > SUBSCRIPTION_HARTBEAT_INTERVAL ? SubscriptionType.HEARTBEAT : SubscriptionType.DUPLICATED;
            }
