...
public final class FacebookSdk {
    ...
    public static void publishInstallAsync(Context context, final String str) {
        ...
        getExecutor().execute(new Runnable() {
            public void run() {
                FacebookSdk.a(applicationContext2, str);
            }
        });
    }
    ...
    public static synchronized void sdkInitialize(final android.content.Context r3, final com.facebook.FacebookSdk.InitializeCallback r4) {
        ...
        L_0x0012:
            ...
            boolean r1 = com.facebook.internal.Utility.isNullOrEmpty((java.lang.String) r1)     // Catch:{ all -> 0x0081 }
        ...
        L_0x0079:
            ...
            r3.<init>((java.lang.String) r4)     // Catch:{ all -> 0x0081 }
