        ...
        if (dialogWebFallbackUri != null) {
            ...
            if (queryParamsForPlatformActivityIntentWebFallback != null) {
                if (dialogWebFallbackUri.isRelative()) {
                    str2 = ServerProtocol.getDialogAuthority();
                    str = dialogWebFallbackUri.toString();
                } else {
                    str2 = dialogWebFallbackUri.getAuthority();
                    str = dialogWebFallbackUri.getPath();
                }
                Uri buildUri = Utility.buildUri(str2, str, queryParamsForPlatformActivityIntentWebFallback);
                Bundle bundle2 = new Bundle();
