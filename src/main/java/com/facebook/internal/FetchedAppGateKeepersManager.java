            ...
            if (!isTimestampValid(timestamp)) {
                ...
                FacebookSdk.getExecutor().execute(new Runnable() {
                    public void run() {
                        ...
                        JSONObject a2 = FetchedAppGateKeepersManager.getAppGateKeepersQueryResponse(applicationId);
                        if (a2 != null) {
                            Long unused2 = FetchedAppGateKeepersManager.timestamp = Long.valueOf(System.currentTimeMillis());
                            JSONObject unused3 = FetchedAppGateKeepersManager.parseAppGateKeepersFromJSON(applicationId, a2);
