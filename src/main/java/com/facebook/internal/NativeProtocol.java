...
public final class NativeProtocol {
    ...
    private static Uri buildPlatformProviderVersionURI(NativeAppInfo nativeAppInfo) {
        return Uri.parse(CONTENT_SCHEME + nativeAppInfo.a() + PLATFORM_PROVIDER_VERSIONS);
    }
    ...
    public static Intent createFacebookLiteIntent(Context context, String str, Collection<String> collection, String str2, boolean z, boolean z2, DefaultAudience defaultAudience, String str3, String str4) {
        ...
        return a(context, createNativeAppIntent(fBLiteAppInfo, str, collection, str2, z, z2, defaultAudience, str3, str4), fBLiteAppInfo);
    }
    ...
    private static Intent createNativeAppIntent(NativeAppInfo nativeAppInfo, String str, Collection<String> collection, String str2, boolean z, boolean z2, DefaultAudience defaultAudience, String str3, String str4) {
        String b = nativeAppInfo.b();
        if (b == null) {
            return null;
        }
        Intent putExtra = new Intent().setClassName(nativeAppInfo.a(), b).putExtra("client_id", str);
    ...
    public static Intent createPlatformActivityIntent(Context context, String str, String str2, ProtocolVersionQueryResult protocolVersionQueryResult, Bundle bundle) {
        NativeAppInfo a;
        Intent a2;
        if (protocolVersionQueryResult == null || (a = protocolVersionQueryResult.nativeAppInfo) == null || (a2 = a(context, new Intent().setAction("com.facebook.platform.PLATFORM_ACTIVITY").setPackage(a.a()).addCategory("android.intent.category.DEFAULT"), a)) == null) {
            return null;
        }
        setupProtocolRequestIntent(a2, str, str2, protocolVersionQueryResult.protocolVersion, bundle);
        return a2;
    }

    public static Intent createPlatformServiceIntent(Context context) {
        for (NativeAppInfo next : facebookAppInfoList) {
            Intent b = b(context, new Intent("com.facebook.platform.PLATFORM_SERVICE").setPackage(next.a()).addCategory("android.intent.category.DEFAULT"), next);
            if (b != null) {
                return b;
            }
        }
    ...
    public static Intent createProxyAuthIntent(Context context, String str, Collection<String> collection, String str2, boolean z, boolean z2, DefaultAudience defaultAudience, String str3, String str4) {
        for (NativeAppInfo next : facebookAppInfoList) {
            Context context2 = context;
            Intent a = a(context, createNativeAppIntent(next, str, collection, str2, z, z2, defaultAudience, str3, str4), next);
            if (a != null) {
                return a;
            }
        }
    ...
    public static Intent createTokenRefreshIntent(Context context) {
        for (NativeAppInfo next : facebookAppInfoList) {
            Intent b = b(context, new Intent().setClassName(next.a(), FACEBOOK_TOKEN_REFRESH_ACTIVITY), next);
            if (b != null) {
                return b;
            }
        }
    ...
    public static java.util.TreeSet<java.lang.Integer> fetchAllAvailableProtocolVersionsForAppInfo(com.facebook.internal.NativeProtocol.NativeAppInfo r8) {
        /*
            ...
            android.net.Uri r3 = buildPlatformProviderVersionURI(r8)
            r1 = 0
            android.content.Context r5 = com.facebook.FacebookSdk.getApplicationContext()     // Catch:{ all -> 0x0076 }
            android.content.pm.PackageManager r5 = r5.getPackageManager()     // Catch:{ all -> 0x0076 }
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ all -> 0x0076 }
            r6.<init>()     // Catch:{ all -> 0x0076 }
            java.lang.String r8 = r8.a()     // Catch:{ all -> 0x0076 }
            r6.append(r8)     // Catch:{ all -> 0x0076 }
            java.lang.String r8 = ".provider.PlatformProvider"
            r6.append(r8)     // Catch:{ all -> 0x0076 }
            java.lang.String r8 = r6.toString()     // Catch:{ all -> 0x0076 }
            r6 = 0
            android.content.pm.ProviderInfo r8 = r5.resolveContentProvider(r8, r6)     // Catch:{ RuntimeException -> 0x003b }
            goto L_0x0044
        L_0x003b:
            r8 = move-exception
            java.lang.String r5 = TAG     // Catch:{ all -> 0x0076 }
        ...
        L_0x0044:
            ...
            r6 = 0
            r7 = 0
            android.database.Cursor r8 = r2.query(r3, r4, r5, r6, r7)     // Catch:{ IllegalArgumentException | NullPointerException | SecurityException -> 0x004f }
            r1 = r8
            goto L_0x0056
        L_0x004f:
            java.lang.String r8 = TAG     // Catch:{ all -> 0x0076 }
            java.lang.String r2 = "Failed to query content resolver."
            android.util.Log.e(r8, r2)     // Catch:{ all -> 0x0076 }
        L_0x0056:
            if (r1 == 0) goto L_0x0070
        L_0x0058:
            boolean r8 = r1.moveToNext()     // Catch:{ all -> 0x0076 }
            if (r8 == 0) goto L_0x0070
            java.lang.String r8 = "version"
            int r8 = r1.getColumnIndex(r8)     // Catch:{ all -> 0x0076 }
            int r8 = r1.getInt(r8)     // Catch:{ all -> 0x0076 }
    ...
    public static void updateAllAvailableProtocolVersionsAsync() {
        if (protocolVersionsAsyncUpdating.compareAndSet(false, true)) {
            FacebookSdk.getExecutor().execute(new Runnable() {
                public void run() {
                    try {
                        for (NativeAppInfo a : NativeProtocol.facebookAppInfoList) {
                            a.fetchAvailableVersions(true);
                        }
                    } finally {
