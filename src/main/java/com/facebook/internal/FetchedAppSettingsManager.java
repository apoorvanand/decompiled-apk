        ...
        if (Utility.isNullOrEmpty(applicationId)) {
            ...
            FacebookSdk.getExecutor().execute(new Runnable() {
                public void run() {
                    ...
                    JSONObject a2 = FetchedAppSettingsManager.getAppSettingsQueryResponse(applicationId);
                    if (a2 != null) {
                        FetchedAppSettings unused = FetchedAppSettingsManager.parseAppSettingsFromJSON(applicationId, a2);
