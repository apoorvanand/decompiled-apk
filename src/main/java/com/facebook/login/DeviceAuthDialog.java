...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public void completeLogin(String str, Utility.PermissionsPair permissionsPair, String str2, Date date, Date date2) {
        this.deviceAuthMethodHandler.onSuccess(str2, FacebookSdk.getApplicationId(), str, permissionsPair.getGrantedPermissions(), permissionsPair.getDeclinedPermissions(), AccessTokenSource.DEVICE_AUTH, date, (Date) null, date2);
        this.dialog.dismiss();
    }

    private GraphRequest getPollRequest() {
        Bundle bundle = new Bundle();
        bundle.putString(Constant.PARAM_ERROR_CODE, this.currentRequestState.getRequestCode());
            ...
            public void onCompleted(GraphResponse graphResponse) {
                if (!DeviceAuthDialog.this.completed.get()) {
                    ...
                    try {
                        ...
                        DeviceAuthDialog.this.a(new FacebookException((Throwable) e));
                    }
                }
            }
        });
    ...
    public void onSuccess(String str, Long l, Long l2) {
        ...
        new GraphRequest(new AccessToken(str, FacebookSdk.getApplicationId(), AppEventsConstants.EVENT_PARAM_VALUE_NO, (Collection<String>) null, (Collection<String>) null, (AccessTokenSource) null, date2, (Date) null, date), "me", bundle, HttpMethod.GET, new GraphRequest.Callback() {
            public void onCompleted(GraphResponse graphResponse) {
                if (!DeviceAuthDialog.this.completed.get()) {
    ...
    /* access modifiers changed from: private */
    public void presentConfirmation(String str, Utility.PermissionsPair permissionsPair, String str2, String str3, Date date, Date date2) {
        ...
        final Utility.PermissionsPair permissionsPair2 = permissionsPair;
        ...
        builder.setMessage(string).setCancelable(true).setNegativeButton(format, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                DeviceAuthDialog.this.dialog.setContentView(DeviceAuthDialog.this.b(false));
                DeviceAuthDialog deviceAuthDialog = DeviceAuthDialog.this;
                deviceAuthDialog.startLogin(deviceAuthDialog.mRequest);
            }
        });
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        this.dialog.setContentView(b(DeviceRequestsHelper.isAvailable() && !this.isRetry));
        return this.dialog;
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.deviceAuthMethodHandler = (DeviceAuthMethodHandler) ((LoginFragment) ((FacebookActivity) getActivity()).getCurrentFragment()).c().d();
    ...
    public void startLogin(LoginClient.Request request) {
        ...
        String h = request.h();
        if (h != null) {
            bundle.putString(DeviceRequestsHelper.DEVICE_TARGET_USER_ID, h);
        }
