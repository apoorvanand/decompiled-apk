...
public class CustomTabLoginMethodHandler extends WebLoginMethodHandler {
    ...
    private static final String CUSTOM_TABS_SERVICE_ACTION = "androidx.browser.customtabs.action.CustomTabsService";
    ...
    private String getChromePackage() {
        ...
        List<ResolveInfo> queryIntentServices = a.getPackageManager().queryIntentServices(new Intent(CUSTOM_TABS_SERVICE_ACTION), 0);
    ...
    private boolean isCustomTabsCompatibleWithAutofill() {
        return !Utility.isAutofillAvailable(this.b.a());
    }

    private boolean isCustomTabsEnabled() {
        FetchedAppSettings appSettingsWithoutQuery = FetchedAppSettingsManager.getAppSettingsWithoutQuery(Utility.getMetadataApplicationId(this.b.a()));
    ...
    public boolean a(int i, int i2, Intent intent) {
        ...
        super.a(pendingRequest, (Bundle) null, new FacebookOperationCanceledException());
        return false;
    }
    ...
    public boolean a(LoginClient.Request request) {
        ...
        Intent intent = new Intent(this.b.a(), CustomTabMainActivity.class);
        intent.putExtra(CustomTabMainActivity.EXTRA_PARAMS, a);
        intent.putExtra(CustomTabMainActivity.EXTRA_CHROME_PACKAGE, getChromePackage());
        this.b.getFragment().startActivityForResult(intent, 1);
        return true;
    }
