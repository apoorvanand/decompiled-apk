...
final class SequencesKt__SequencesKt$ifEmpty$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        SequencesKt__SequencesKt$ifEmpty$1 sequencesKt__SequencesKt$ifEmpty$1 = new SequencesKt__SequencesKt$ifEmpty$1(this.c, this.d, continuation);
        ...
        switch (this.b) {
            case 0:
                ...
                if (it.hasNext()) {
                    ...
                    this.a = it;
                    this.b = 2;
                    if (sequenceScope.yieldAll((Sequence) this.d.invoke(), (Continuation<? super Unit>) this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
                break;
