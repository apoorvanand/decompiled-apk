...
public final class SequencesKt___SequencesKt$minus$3 implements Sequence<T> {
    ...
    public Iterator<T> iterator() {
        Collection convertToSetForSetOperation = CollectionsKt.convertToSetForSetOperation(this.b);
        return (convertToSetForSetOperation.isEmpty() ? this.a : SequencesKt.filterNot(this.a, new SequencesKt___SequencesKt$minus$3$iterator$1(convertToSetForSetOperation))).iterator();
    }
}
