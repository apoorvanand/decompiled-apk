...
public final class SequencesKt___SequencesKt$minus$4 implements Sequence<T> {
    ...
    public Iterator<T> iterator() {
        HashSet hashSet = SequencesKt.toHashSet(this.b);
        return (hashSet.isEmpty() ? this.a : SequencesKt.filterNot(this.a, new SequencesKt___SequencesKt$minus$4$iterator$1(hashSet))).iterator();
    }
}
