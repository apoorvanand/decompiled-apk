...
public final class UShort implements Comparable<UShort> {
    ...
    private static final int m228div7apg3OU(short s, byte b) {
        return UnsignedKt.m286uintDivideJ1ME1BU(UInt.m88constructorimpl(s & MAX_VALUE), UInt.m88constructorimpl(b & 255));
    }
    ...
    public static boolean m232equalsimpl(short s, @Nullable Object obj) {
    ...
    private static final int m247rem7apg3OU(short s, byte b) {
        return UnsignedKt.m287uintRemainderJ1ME1BU(UInt.m88constructorimpl(s & MAX_VALUE), UInt.m88constructorimpl(b & 255));
    }
