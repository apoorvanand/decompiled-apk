...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    @PublishedApi
    /* renamed from: constructor-impl  reason: not valid java name */
    public static int[] m134constructorimpl(@NotNull int[] iArr) {
        Intrinsics.checkParameterIsNotNull(iArr, "storage");
        return iArr;
    }
    ...
    public static boolean m136containsAllimpl(int[] iArr, @NotNull Collection<UInt> collection) {
        boolean z;
    ...
    public static final boolean m138equalsimpl0(@NotNull int[] iArr, @NotNull int[] iArr2) {
