...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    @PublishedApi
    /* renamed from: constructor-impl  reason: not valid java name */
    public static long[] m203constructorimpl(@NotNull long[] jArr) {
        Intrinsics.checkParameterIsNotNull(jArr, "storage");
        return jArr;
    }
    ...
    public static boolean m205containsAllimpl(long[] jArr, @NotNull Collection<ULong> collection) {
        boolean z;
    ...
    public static final boolean m207equalsimpl0(@NotNull long[] jArr, @NotNull long[] jArr2) {
