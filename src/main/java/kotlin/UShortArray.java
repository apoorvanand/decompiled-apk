...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static short[] m269constructorimpl(int i) {
        return m270constructorimpl(new short[i]);
    }

    @NotNull
    @PublishedApi
    /* renamed from: constructor-impl  reason: not valid java name */
    public static short[] m270constructorimpl(@NotNull short[] sArr) {
        Intrinsics.checkParameterIsNotNull(sArr, "storage");
        return sArr;
    }

    /* renamed from: contains-xj2QHRw  reason: not valid java name */
    public static boolean m271containsxj2QHRw(short[] sArr, short s) {
        return ArraysKt.contains(sArr, s);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m272containsAllimpl(short[] sArr, @NotNull Collection<UShort> collection) {
        boolean z;
        ...
        for (Object next : iterable) {
            if (!(next instanceof UShort) || !ArraysKt.contains(sArr, ((UShort) next).m267unboximpl())) {
                z = false;
                continue;
            } else {
                z = true;
    ...
    public static boolean m273equalsimpl(short[] sArr, @Nullable Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual((Object) sArr, (Object) ((UShortArray) obj).m284unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m274equalsimpl0(@NotNull short[] sArr, @NotNull short[] sArr2) {
    ...
    public static final short m275getimpl(short[] sArr, int i) {
        return UShort.m226constructorimpl(sArr[i]);
    }

    /* renamed from: getSize-impl  reason: not valid java name */
    public static int m276getSizeimpl(short[] sArr) {
        return sArr.length;
    }
    ...
    public static boolean m278isEmptyimpl(short[] sArr) {
        return sArr.length == 0;
    }

    @NotNull
    /* renamed from: iterator-impl  reason: not valid java name */
    public static UShortIterator m279iteratorimpl(short[] sArr) {
        return new Iterator(sArr);
    }

    /* renamed from: set-01HTLdE  reason: not valid java name */
    public static final void m280set01HTLdE(short[] sArr, int i, short s) {
        sArr[i] = s;
    }
