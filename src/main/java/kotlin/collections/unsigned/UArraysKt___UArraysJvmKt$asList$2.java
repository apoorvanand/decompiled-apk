...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public boolean m353containsVKZWuLQ(long j) {
        return ULongArray.m204containsVKZWuLQ(this.a, j);
    }

    @NotNull
    public ULong get(int i) {
        return ULong.m151boximpl(ULongArray.m208getimpl(this.a, i));
    }

    public int getSize() {
        return ULongArray.m209getSizeimpl(this.a);
    }
    ...
    public int m354indexOfVKZWuLQ(long j) {
        return ArraysKt.indexOf(this.a, j);
    }

    public boolean isEmpty() {
        return ULongArray.m211isEmptyimpl(this.a);
    }
    ...
    public int m355lastIndexOfVKZWuLQ(long j) {
