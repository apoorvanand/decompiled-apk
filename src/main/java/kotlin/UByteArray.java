...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    @PublishedApi
    /* renamed from: constructor-impl  reason: not valid java name */
    public static byte[] m65constructorimpl(@NotNull byte[] bArr) {
        Intrinsics.checkParameterIsNotNull(bArr, "storage");
        return bArr;
    }
    ...
    public static boolean m67containsAllimpl(byte[] bArr, @NotNull Collection<UByte> collection) {
        boolean z;
    ...
    public static final boolean m69equalsimpl0(@NotNull byte[] bArr, @NotNull byte[] bArr2) {
