...
public final class UStringsKt {
    ...
    public static final String m885toStringJSWoG40(long j, int i) {
    ...
    public static final String m886toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m887toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m888toStringolVBNx4(short s, int i) {
    ...
    public static final UInt toUIntOrNull(@NotNull String str, int i) {
        ...
        int r2 = UnsignedKt.m286uintDivideJ1ME1BU(-1, r4);
        while (i3 < length) {
    ...
    public static final ULong toULongOrNull(@NotNull String str, int i) {
        ...
        long r2 = UnsignedKt.m288ulongDivideeb3DHEI(-1, ULong.m157constructorimpl(r5));
        long j = 0;
        while (i2 < length) {
    ...
    public static final UShort toUShortOrNull(@NotNull String str, int i) {
        ...
        int r1 = uIntOrNull.m131unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m88constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m220boximpl(UShort.m226constructorimpl((short) r1));
    }
}
