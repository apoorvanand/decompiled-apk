...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        private static class StubCompat extends IMediaControllerCallback.Stub {
            ...
            public void onCaptioningEnabledChanged(boolean z) {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.a(11, Boolean.valueOf(z), (Bundle) null);
                }
            }
            ...
            public void onExtrasChanged(Bundle bundle) {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.a(7, bundle, (Bundle) null);
                }
            }
            ...
            public void onMetadataChanged(MediaMetadataCompat mediaMetadataCompat) {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.a(3, mediaMetadataCompat, (Bundle) null);
                }
            }
            ...
            public void onPlaybackStateChanged(PlaybackStateCompat playbackStateCompat) {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.a(2, playbackStateCompat, (Bundle) null);
                }
            }
            ...
            public void onQueueTitleChanged(CharSequence charSequence) {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.a(6, charSequence, (Bundle) null);
                }
            }
            ...
            public void onRepeatModeChanged(int i) {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.a(9, Integer.valueOf(i), (Bundle) null);
                }
            }
            ...
            public void onSessionDestroyed() {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.a(8, (Object) null, (Bundle) null);
                }
            }
            ...
            public void onSessionReady() {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.a(13, (Object) null, (Bundle) null);
                }
            }
            ...
            public void onShuffleModeChanged(int i) {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.a(12, Integer.valueOf(i), (Bundle) null);
                }
            }
            ...
            public void onVolumeInfoChanged(ParcelableVolumeInfo parcelableVolumeInfo) {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.a(4, parcelableVolumeInfo != null ? new PlaybackInfo(parcelableVolumeInfo.volumeType, parcelableVolumeInfo.audioStream, parcelableVolumeInfo.controlType, parcelableVolumeInfo.maxVolume, parcelableVolumeInfo.currentVolume) : null, (Bundle) null);
                }
            }
        }
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public MediaControllerImplApi21(Context context, MediaSessionCompat.Token token) {
            ...
            } else if (this.c.getExtraBinder() == null) {
                requestExtraBinder();
            }
        }
