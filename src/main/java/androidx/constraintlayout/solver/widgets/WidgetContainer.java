...
public class WidgetContainer extends ConstraintWidget {
    ...
    public ConstraintWidget findWidget(float f, float f2) {
        ...
        for (int i = 0; i < size; i++) {
            ConstraintWidget constraintWidget2 = this.aj.get(i);
    ...
    public ArrayList<ConstraintWidget> findWidgets(int i, int i2, int i3, int i4) {
        ...
        int size = this.aj.size();
        for (int i5 = 0; i5 < size; i5++) {
            ConstraintWidget constraintWidget = this.aj.get(i5);
    ...
    public void layout() {
        updateDrawPosition();
        ArrayList<ConstraintWidget> arrayList = this.aj;
        if (arrayList != null) {
            int size = arrayList.size();
            for (int i = 0; i < size; i++) {
    ...
    public void resetSolverVariables(Cache cache) {
        ...
        int size = this.aj.size();
        for (int i = 0; i < size; i++) {
            this.aj.get(i).resetSolverVariables(cache);
        }
    }
