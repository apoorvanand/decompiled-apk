...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    public boolean getPadding(Rect rect) {
        int ceil = (int) Math.ceil((double) a(this.mRawMaxShadowSize, this.mCornerRadius, this.mAddPaddingForCorners));
        int ceil2 = (int) Math.ceil((double) b(this.mRawMaxShadowSize, this.mCornerRadius, this.mAddPaddingForCorners));
