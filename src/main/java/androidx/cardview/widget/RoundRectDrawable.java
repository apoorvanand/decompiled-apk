...
class RoundRectDrawable extends Drawable {
    ...
    private void updateBounds(Rect rect) {
        ...
        if (this.mInsetForPadding) {
            float a = RoundRectDrawableWithShadow.a(this.mPadding, this.mRadius, this.mInsetForRadius);
            this.mBoundsI.inset((int) Math.ceil((double) RoundRectDrawableWithShadow.b(this.mPadding, this.mRadius, this.mInsetForRadius)), (int) Math.ceil((double) a));
