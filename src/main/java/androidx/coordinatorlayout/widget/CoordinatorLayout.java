...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public boolean a(androidx.coordinatorlayout.widget.CoordinatorLayout r2, android.view.View r3, android.view.View r4) {
            ...
            L_0x001c:
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.coordinatorlayout.widget.CoordinatorLayout.LayoutParams.a(androidx.coordinatorlayout.widget.CoordinatorLayout, android.view.View, android.view.View):boolean");
        }
    ...
    private void offsetChildByInset(View view, Rect rect, int i) {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if ((absoluteGravity & 80) == 80 && (height = ((getHeight() - acquireTempRect.bottom) - layoutParams.bottomMargin) + layoutParams.e) < rect.bottom) {
    ...
    public final void a(int i) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (i2 != 0 || view.getVisibility() != 8) {
                ...
                if (i2 != 2) {
                    c(view, acquireTempRect3);
                    if (!acquireTempRect3.equals(acquireTempRect2)) {
                        b(view, acquireTempRect2);
                    }
                }
    ...
    public void a(View view, int i) {
        ...
        if (layoutParams.f != null) {
            ...
            boolean z = false;
            a(view2, false, acquireTempRect2);
            int measuredWidth = view.getMeasuredWidth();
            int measuredHeight = view.getMeasuredHeight();
