...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner {
    ...
    public LayoutInflater getLayoutInflater(@Nullable Bundle bundle) {
        ...
        if (fragmentHostCallback != null) {
            ...
            LayoutInflaterCompat.setFactory2(onGetLayoutInflater, this.mChildFragmentManager.j());
    ...
    public Object getReturnTransition() {
        ...
        return animationInfo.h == USE_DEFAULT_TRANSITION ? getEnterTransition() : this.mAnimationInfo.h;
    }
    ...
    public Object getSharedElementReturnTransition() {
        ...
        return animationInfo.l == USE_DEFAULT_TRANSITION ? getSharedElementEnterTransition() : this.mAnimationInfo.l;
    }
    ...
    public void setOnStartEnterTransitionListener(OnStartEnterTransitionListener onStartEnterTransitionListener) {
        ensureAnimationInfo();
        if (onStartEnterTransitionListener != this.mAnimationInfo.r) {
            if (onStartEnterTransitionListener == null || this.mAnimationInfo.r == null) {
                if (this.mAnimationInfo.q) {
                    this.mAnimationInfo.r = onStartEnterTransitionListener;
                }
                if (onStartEnterTransitionListener != null) {
    ...
    public void startPostponedEnterTransition() {
        ...
        } else if (Looper.myLooper() != this.mFragmentManager.m.c().getLooper()) {
            this.mFragmentManager.m.c().postAtFrontOfQueue(new Runnable() {
                public void run() {
