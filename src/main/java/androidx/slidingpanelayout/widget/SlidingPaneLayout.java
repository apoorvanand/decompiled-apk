...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private void dimChildView(View view, float f2, int i) {
        ...
        if (f2 > 0.0f && i != 0) {
            ...
            if (layoutParams.c != null) {
                layoutParams.c.setColorFilter((ColorFilter) null);
            }
    ...
    public void a(int i) {
        ...
        this.b = ((float) (i - ((b2 ? getPaddingRight() : getPaddingLeft()) + (b2 ? layoutParams.rightMargin : layoutParams.leftMargin)))) / ((float) this.c);
    ...
    public void draw(Canvas canvas) {
        ...
        int i2;
        super.draw(canvas);
        Drawable drawable = b() ? this.mShadowDrawableRight : this.mShadowDrawableLeft;
    ...
    public void onMeasure(int r21, int r22) {
        ...
        L_0x012b:
            ...
            r3 = 0
        L_0x0130:
            if (r3 >= r9) goto L_0x021c
            android.view.View r4 = r0.getChildAt(r3)
            int r6 = r4.getVisibility()
            if (r6 != r15) goto L_0x0143
        L_0x013c:
            r19 = r1
        L_0x013e:
            r1 = 0
