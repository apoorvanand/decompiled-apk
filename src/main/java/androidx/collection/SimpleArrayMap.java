...
public class SimpleArrayMap<K, V> {
    ...
    public int a() {
        ...
        int binarySearchHashes = binarySearchHashes(this.f, i, 0);
        if (binarySearchHashes < 0 || this.g[binarySearchHashes << 1] == null) {
    ...
    public int a(Object obj, int i) {
        ...
        int binarySearchHashes = binarySearchHashes(this.f, i2, i);
        if (binarySearchHashes < 0 || obj.equals(this.g[binarySearchHashes << 1])) {
            return binarySearchHashes;
        }
        int i3 = binarySearchHashes + 1;
