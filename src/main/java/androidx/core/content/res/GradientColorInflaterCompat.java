    ...
    static Shader a(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) {
        ...
        if (name.equals("gradient")) {
            ...
            switch (namedInt) {
                case 1:
                    if (namedFloat7 > 0.0f) {
                        int[] iArr = checkColors.a;
                        return new RadialGradient(namedFloat5, namedFloat6, namedFloat7, iArr, checkColors.b, parseTileMode(namedInt2));
                    }
                    throw new XmlPullParserException("<gradient> tag requires 'gradientRadius' attribute with radial type");
                case 2:
                    return new SweepGradient(namedFloat5, namedFloat6, checkColors.a, checkColors.b);
                default:
                    return new LinearGradient(namedFloat, namedFloat2, namedFloat3, f, checkColors.a, checkColors.b, parseTileMode(namedInt2));
            }
        } else {
