  ...
  PHI: (r6v2 java.lang.String) = (r6v1 java.lang.String), (r6v3 java.lang.String) binds: [B:0:0x0000, B:14:0x0005] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC, Splitter:B:1:0x0005] */
    ...
    private static void gatherMapLinks(java.util.ArrayList<androidx.core.text.util.LinkifyCompat.LinkSpec> r5, android.text.Spannable r6) {
        ...
        L_0x0012:
            ...
            int r4 = r4 + r2
            int r2 = r2 + r0
            r3.c = r2     // Catch:{ UnsupportedOperationException -> 0x0043 }
            int r0 = r0 + r4
            r3.d = r0     // Catch:{ UnsupportedOperationException -> 0x0043 }
            ...
            r3.b = r1     // Catch:{ UnsupportedOperationException -> 0x0043 }
    ...
    private static void pruneOverlaps(ArrayList<LinkSpec> arrayList, Spannable spannable) {
        ...
        while (i < size - 1) {
            ...
            if (linkSpec2.c <= linkSpec3.c && linkSpec2.d > linkSpec3.c) {
                ...
                if (i4 != -1) {
                    URLSpan uRLSpan = arrayList.get(i4).a;
                    if (uRLSpan != null) {
