...
public class FontsContractCompat {
    ...
    public static FontFamilyResult fetchFonts(@NonNull Context context, @Nullable CancellationSignal cancellationSignal, @NonNull FontRequest fontRequest) {
        ...
        return provider == null ? new FontFamilyResult(1, (FontInfo[]) null) : new FontFamilyResult(0, a(context, fontRequest, provider.authority, cancellationSignal));
    }
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r2, final androidx.core.provider.FontRequest r3, @androidx.annotation.Nullable final androidx.core.content.res.ResourcesCompat.FontCallback r4, @androidx.annotation.Nullable final android.os.Handler r5, boolean r6, int r7, final int r8) {
        /*
            ...
            androidx.collection.LruCache<java.lang.String, android.graphics.Typeface> r1 = a
        ...
        L_0x0028:
            ...
            androidx.core.provider.FontsContractCompat$TypefaceResult r2 = a(r2, r3, r8)
        ...
        L_0x0045:
            ...
            android.graphics.Typeface r2 = r3.a     // Catch:{ InterruptedException -> 0x0057 }
        L_0x0057:
            return r2
        L_0x0058:
        ...
        L_0x0061:
            ...
            monitor-enter(r4)
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r5 = c     // Catch:{ all -> 0x0096 }
        ...
        L_0x007b:
            ...
            r5.add(r3)     // Catch:{ all -> 0x0096 }
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r3 = c     // Catch:{ all -> 0x0096 }
