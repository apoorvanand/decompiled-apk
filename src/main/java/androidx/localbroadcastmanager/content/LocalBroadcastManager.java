...
public final class LocalBroadcastManager {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0036, code lost:
        r6.b.onReceive(r9.mAppContext, r3.a);
     */
    ...
    public void a() {
        ...
        L_0x001c:
            ...
            r3 = r1[r2]
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord> r4 = r3.b
            int r4 = r4.size()
            r5 = 0
        L_0x0028:
            if (r5 >= r4) goto L_0x0042
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord> r6 = r3.b
    ...
    public boolean sendBroadcast(@androidx.annotation.NonNull android.content.Intent r22) {
        ...
        L_0x0056:
            java.util.HashMap<java.lang.String, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r3 = r1.mActions     // Catch:{ all -> 0x016c }
        ...
        L_0x0080:
            ...
            r5 = r3
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r5 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r5     // Catch:{ all -> 0x016c }
            ...
            android.content.IntentFilter r9 = r5.a     // Catch:{ all -> 0x016c }
            r4.append(r9)     // Catch:{ all -> 0x016c }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x016c }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x016c }
        L_0x00a7:
            boolean r3 = r5.c     // Catch:{ all -> 0x016c }
        ...
        L_0x00b4:
            ...
            goto L_0x012e
        L_0x00c0:
            android.content.IntentFilter r3 = r5.a     // Catch:{ all -> 0x016c }
        ...
        L_0x013e:
            ...
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r4 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r4     // Catch:{ all -> 0x016c }
            r5 = 0
            r4.c = r5     // Catch:{ all -> 0x016c }
            int r3 = r3 + 1
            goto L_0x013e
        L_0x0150:
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r3 = r1.mPendingBroadcasts     // Catch:{ all -> 0x016c }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord r4 = new androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x016c }
