...
public abstract class VersionedParcel {
    ...
    private <T, S extends java.util.Collection<T>> S readCollection(int r3, S r4) {
        ...
        L_0x0045:
            if (r3 <= 0) goto L_0x0051
            androidx.versionedparcelable.VersionedParcelable r0 = r2.h()
            r4.add(r0)
            int r3 = r3 + -1
            goto L_0x0045
        L_0x0051:
    ...
    public <T> T[] b(T[] r5) {
        ...
        L_0x004a:
            if (r0 <= 0) goto L_0x0056
            androidx.versionedparcelable.VersionedParcelable r1 = r4.h()
            r2.add(r1)
            int r0 = r0 + -1
            goto L_0x004a
        L_0x0056:
    ...
    /* access modifiers changed from: protected */
    public <T extends VersionedParcelable> T h() {
        String readString = readString();
        if (readString == null) {
            return null;
        }
        return a(readString, a());
    }
    ...
    public <T> T[] readArray(T[] tArr, int i) {
        return !readField(i) ? tArr : b(tArr);
    }
