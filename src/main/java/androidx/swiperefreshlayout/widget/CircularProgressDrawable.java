...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private void applyFinishTranslation(float f, Ring ring) {
        a(f, ring);
        ring.b(ring.l() + (((ring.m() - MIN_PROGRESS_ARC) - ring.l()) * f));
        ring.c(ring.m());
        ring.d(ring.t() + ((((float) (Math.floor((double) (ring.t() / MAX_PROGRESS_ARC)) + 1.0d)) - ring.t()) * f));
    }
    ...
    public void a(float f, Ring ring) {
        ring.a(f > COLOR_CHANGE_OFFSET ? evaluateColorChange((f - COLOR_CHANGE_OFFSET) / 0.25f, ring.n(), ring.f()) : ring.n());
    }
    ...
    public void a(float f, Ring ring, boolean z) {
        ...
        if (this.b) {
            ...
            if (f < SHRINK_OFFSET) {
                ...
                float l = ring.l();
                float f5 = l;
                f2 = (MATERIAL_INTERPOLATOR.getInterpolation(f4) * 0.79f) + MIN_PROGRESS_ARC + l;
                f3 = f5;
            } else {
