...
class ActivityChooserModel extends DataSetObservable {
    ...
    private final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        public java.lang.Void doInBackground(java.lang.Object... r12) {
            ...
            L_0x0077:
                r0 = move-exception
                java.lang.String r1 = androidx.appcompat.widget.ActivityChooserModel.a     // Catch:{ all -> 0x0075 }
            ...
            L_0x00e8:
                r0 = move-exception
                java.lang.String r1 = androidx.appcompat.widget.ActivityChooserModel.a
    ...
    private boolean loadActivitiesIfNeeded() {
        ...
        List<ResolveInfo> queryIntentActivities = this.b.getPackageManager().queryIntentActivities(this.mIntent, 0);
    ...
    private void persistHistoricalDataIfNeeded() {
        if (!this.mReadShareHistoryCalled) {
            ...
            if (!TextUtils.isEmpty(this.c)) {
                new PersistHistoryAsyncTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Object[]{new ArrayList(this.mHistoricalRecords), this.c});
            }
        }
    }
    ...
    private void readHistoricalDataImpl() {
        try {
            ...
            try {
                ...
                String str = a;
                Log.e(str, "Error reading historical recrod file: " + this.c, e);
                if (openFileInput == null) {
                }
            } catch (IOException e2) {
                String str2 = a;
                Log.e(str2, "Error reading historical recrod file: " + this.c, e2);
                if (openFileInput == null) {
                }
            } catch (Throwable th) {
                if (openFileInput != null) {
