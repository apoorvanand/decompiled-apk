...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private final SearchManager mSearchManager = ((SearchManager) this.d.getSystemService(FirebaseAnalytics.Event.SEARCH));
    ...
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r7) {
        /*
            ...
            android.graphics.drawable.Drawable r7 = r6.a(r7)     // Catch:{ NotFoundException -> 0x0012 }
            return r7
        L_0x0012:
