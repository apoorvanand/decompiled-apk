...
public class SwitchCompat extends CompoundButton {
    ...
    private void animateThumbToCheckedState(boolean z) {
        this.b = ObjectAnimator.ofFloat(this, THUMB_POS, new float[]{z ? 1.0f : 0.0f});
    ...
    private int getThumbOffset() {
        return (int) (((ViewUtils.isLayoutRtl(this) ? 1.0f - this.a : this.a) * ((float) getThumbScrollRange())) + 0.5f);
    }
            ...
            case 2:
                switch (this.mTouchMode) {
                    ...
                    case 2:
                        ...
                        float constrain = constrain(this.a + f2, 0.0f, 1.0f);
                        if (constrain != this.a) {
                            this.mTouchX = x3;
